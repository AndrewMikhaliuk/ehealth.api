    ...
    stage('Test and build') {
      ...
      parallel {
        ...
        stage('Build ehealth-app') {
          ...
          steps {
            sh 'curl -s https://raw.githubusercontent.com/edenlabllc/ci-utils/umbrella_jenkins/build-container.sh -o build-container.sh; sudo bash ./build-container.sh'
            sh 'curl -s https://raw.githubusercontent.com/edenlabllc/ci-utils/umbrella_jenkins/start-container.sh -o start-container.sh; sudo bash ./start-container.sh'
